...
- Implementing a mechanism for the user to select a book so as to delete it was surprisingly more complicated than I thought. I decided to not use the simple ***focus*** and ***active*** properties and instead keep an internal track of the selected card, and style it with CSS. I think there are much easier ways of implementing that, but I enjoyed the challenge.
